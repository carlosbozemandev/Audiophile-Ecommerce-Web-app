...
export default function Checkout() {
    ...
    return (
        <section className='marginTB'>
            <div className={`${styles.checkoutContainer} flex width100`}>
                <form className={`${styles.checkout} flex b-radius paddingChildren childsMargin`}>
                    <h2 style={{ fontSize: '2rem', letterSpacing: 0.1, fontWeight: 500, marginTop: '1rem' }}>CHECKOUT</h2>
                ...
                <div className={`${styles.summary} flex b-radius`}>
